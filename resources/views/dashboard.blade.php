...
{{-- <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6 2xl:gap-7.5">
    <!-- Card Item Start -->
    <div
        class="shadow-default rounded-sm border border-stroke dark:border-strokedark bg-white dark:bg-boxdark py-6 px-7.5">
        <div
            class="flex items-center justify-center w-11.5 h-11.5 rounded-full bg-meta-2 dark:bg-meta-4">
        ...
        <div class="flex items-end justify-between mt-4">
            <div>
                <h4 class="font-bold text-title-md text-black dark:text-white">
                    $3.456K
                </h4>
                <span class="font-medium text-sm">Total views</span>
            </div>

            <span class="flex items-center gap-1 font-medium text-sm text-meta-3">
                0.43%
    ...
    <div
        ...
        <div class="flex items-end justify-between mt-4">
            <div>
                ...
                <span class="font-medium text-sm">Total Profit</span>
            </div>
    ...
    <div
        ...
        <div class="flex items-end justify-between mt-4">
            <div>
                ...
                <span class="font-medium text-sm">Total Product</span>
            </div>
    ...
    <div
        ...
        <div class="flex items-end justify-between mt-4">
            <div>
                ...
                <span class="font-medium text-sm">Total Users</span>
            </div>

            <span class="flex items-center gap-1 font-medium text-sm text-meta-5">
                0.95%
...
<div class="grid grid-cols-12 gap-4 md:gap-6 2xl:gap-7.5 mt-4 md:mt-6 2xl:mt-7.5">
    <!-- ====== Chart One Start -->
    <div
        class="col-span-12 xl:col-span-8 shadow-default rounded-sm border border-stroke dark:border-strokedark bg-white dark:bg-boxdark px-5 pt-7.5 pb-5 sm:px-7.5">
        <div class="flex flex-wrap gap-3 items-start justify-between sm:flex-nowrap">
            <div class="flex flex-wrap gap-3 sm:gap-5 w-full">
                <div class="flex min-w-47.5">
                    <span
                        class="mt-1 mr-2 flex items-center justify-center h-4 w-full max-w-4 rounded-full border border-primary">
                    ...
                    <div class="w-full">
                        ...
                        <p class="text-sm">12.04.2022 - 12.05.2022</p>
                    </div>
                </div>
                <div class="flex min-w-47.5">
                    <span
                        class="mt-1 mr-2 flex items-center justify-center h-4 w-full max-w-4 rounded-full border border-secondary">
            ...
            <div class="flex w-full max-w-45 justify-end">
                <div class="inline-flex items-center rounded-md bg-whiter dark:bg-meta-4 p-1.5">
                    <button
                        class="rounded py-1 px-3 text-xs font-semibold text-black dark:text-white hover:bg-white dark:hover:bg-boxdark hover:shadow-card shadow-card bg-white dark:bg-boxdark">
                        Day
                    </button>
                    <button
                        class="rounded py-1 px-3 text-xs font-semibold text-black dark:text-white hover:bg-white dark:hover:bg-boxdark hover:shadow-card">
                        Week
                    </button>
                    <button
                        class="rounded py-1 px-3 text-xs font-semibold text-black dark:text-white hover:bg-white dark:hover:bg-boxdark hover:shadow-card">
    ...
    <!-- ====== Chart Two Start -->
    <div
        class="col-span-12 xl:col-span-4 shadow-default rounded-sm border border-stroke dark:border-strokedark bg-white dark:bg-boxdark p-7.5">
        <div class="mb-4 justify-between sm:flex gap-4">
            <div>
                <h4 class="font-semibold text-xl text-black dark:text-white">Profit this week</h4>
            </div>
            <div>
                <div class="relative z-20 inline-block">
                    <select name="#" id="#"
                        class="relative z-20 inline-flex appearance-none bg-transparent py-1 pl-3 pr-8 text-sm outline-none">
    ...
    <!-- ====== Chart Three Start -->
    <div
        class="col-span-12 xl:col-span-5 shadow-default rounded-sm border border-stroke dark:border-strokedark bg-white dark:bg-boxdark px-5 pt-7.5 pb-5 sm:px-7.5">
        <div class="mb-3 justify-between sm:flex gap-4">
            <div>
        ...
        <div class="-mx-8 flex flex-wrap items-center justify-center gap-y-3">
            <div class="w-full px-8 sm:w-1/2">
                <div class="flex w-full items-center">
                    ...
                    <p class="flex w-full justify-between text-sm text-black dark:text-white">
                        <span> Desktop </span>
                        <span> 65% </span>
                    </p>
                </div>
    ...
    <!-- ====== Map One Start -->
    <div
        class="col-span-12 xl:col-span-7 shadow-default rounded-sm border border-stroke dark:border-strokedark bg-white dark:bg-boxdark py-6 px-7.5">
        <h4 class="font-semibold text-xl text-black dark:text-white mb-2">Region labels</h4>
    ...
    <div class="col-span-12 xl:col-span-8">
        <div
            class="shadow-default rounded-sm border border-stroke dark:border-strokedark bg-white dark:bg-boxdark pt-6 pb-2.5 xl:pb-1 px-5 sm:px-7.5">
            <h4 class="font-semibold text-xl text-black dark:text-white mb-6">Top Channels</h4>

            <div class="flex flex-col">
                <div class="grid grid-cols-3 sm:grid-cols-5 bg-gray-2 dark:bg-meta-4 rounded-sm">
                    ...
                    <div class="hidden sm:block p-2.5 xl:p-5 text-center">
                ...
                <div
                    ...
                    <div class="flex items-center gap-3 p-2.5 xl:p-5">
                        <div class="flex-shrink-0"><img src="src/images/brand/brand-01.svg"
                                alt="Brand"></div>
                        <p class="hidden sm:block text-black dark:text-white">Google</p>
                    </div>
                ...
                <div
                    class="grid grid-cols-3 sm:grid-cols-5 border-b border-stroke dark:border-strokedark">
                    <div class="flex items-center gap-3 p-2.5 xl:p-5">
                        <div class="flex-shrink-0"><img src="src/images/brand/brand-02.svg"
                                alt="Brand"></div>
                        <p class="hidden sm:block text-black dark:text-white">Twitter</p>
                    </div>
                ...
                <div
                    class="grid grid-cols-3 sm:grid-cols-5 border-b border-stroke dark:border-strokedark">
                    <div class="flex items-center gap-3 p-2.5 xl:p-5">
                        <div class="flex-shrink-0"><img src="src/images/brand/brand-03.svg"
                                alt="Brand"></div>
                        <p class="hidden sm:block text-black dark:text-white">Github</p>
                    </div>
                ...
                <div
                    class="grid grid-cols-3 sm:grid-cols-5 border-b border-stroke dark:border-strokedark">
                    <div class="flex items-center gap-3 p-2.5 xl:p-5">
                        <div class="flex-shrink-0"><img src="src/images/brand/brand-04.svg"
                                alt="Brand"></div>
                        <p class="hidden sm:block text-black dark:text-white">Vimeo</p>
                    </div>
                ...
                <div class="grid grid-cols-3 sm:grid-cols-5">
                    <div class="flex items-center gap-3 p-2.5 xl:p-5">
                        <div class="flex-shrink-0"><img src="src/images/brand/brand-05.svg"
                                alt="Brand"></div>
                        <p class="hidden sm:block text-black dark:text-white">Facebook</p>
                    </div>

                    <div class="flex items-center justify-center p-2.5 xl:p-5">
                        <p class="text-black dark:text-white">1.2K</p>
                    </div>
                    ...
                    <div class="hidden sm:flex items-center justify-center p-2.5 xl:p-5">
                        <p class="text-black dark:text-white">230</p>
                    </div>
    ...
    <!-- ====== Chat Card Start -->
    <div
        class="col-span-12 xl:col-span-4 shadow-default rounded-sm border border-stroke dark:border-strokedark bg-white dark:bg-boxdark py-6">
        <h4 class="font-semibold text-xl text-black dark:text-white mb-6 px-7.5">Chats</h4>

        <div>
            <a href="messages.html"
                class="flex items-center gap-5 hover:bg-gray-3 dark:hover:bg-meta-4 py-3 px-7.5">
                <div class="relative w-14 h-14 rounded-full">
                    <img src="src/images/user/user-03.png" alt="User">
                    <span
                        class="absolute right-0 bottom-0 w-3.5 h-3.5 rounded-full border-2 border-white bg-meta-3"></span>
                </div>
                ...
                <div class="flex flex-1 items-center justify-between">
                    <div>
                        ...
                        <p>
                            <span class="text-sm text-black dark:text-white">Hello, how are
                                you?</span>
                            <span class="text-xs"> . 12 min</span>
                        </p>
                    </div>
                    <div class="flex items-center justify-center w-6 h-6 rounded-full bg-primary">
                        <span class="font-medium text-sm text-white">3</span>
                    </div>
                </div>
            </a>
            <a href="messages.html"
                ...
                <div class="flex flex-1 items-center justify-between">
                    <div>
                        ...
                        <p>
                            <span class="text-sm">I am waiting for you</span>
            ...
            <a href="messages.html"
                ...
                <div class="relative w-14 h-14 rounded-full">
                    ...
                    <span
                        class="absolute right-0 bottom-0 w-3.5 h-3.5 rounded-full border-2 border-white bg-meta-6"></span>
                </div>
                ...
                <div class="flex flex-1 items-center justify-between">
                    <div>
                        ...
                        <p>
                            <span class="text-sm">Where are you now?</span>
            ...
            <a href="messages.html"
                ...
                <div class="flex flex-1 items-center justify-between">
                    <div>
                        ...
                        <p>
                            <span class="text-sm text-black dark:text-white">Thank you so
                                much!</span>
                            <span class="text-xs"> . Sun</span>
                        </p>
                    </div>
                    <div class="flex items-center justify-center w-6 h-6 rounded-full bg-primary">
                        <span class="font-medium text-sm text-white">2</span>
                    </div>
                </div>
            </a>
            <a href="messages.html"
                ...
                <div class="relative w-14 h-14 rounded-full">
                    ...
                    <span
                        class="absolute right-0 bottom-0 w-3.5 h-3.5 rounded-full border-2 border-white bg-meta-7"></span>
                </div>
                ...
                <div class="flex flex-1 items-center justify-between">
                    <div>
                        ...
                        <p>
                            <span class="text-sm">I really love that!</span>
