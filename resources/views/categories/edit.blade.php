...
<div id="drawer-delete-product-default"
    ...
    <h5 id="drawer-label"
        class="inline-flex items-center text-sm font-bold text-gray-500 uppercase ">Eliminar Categoría
    </h5>
    ...
    <h3 class="mb-6 text-lg text-gray-500 ">¿Está seguro de que desea eliminar esta categoría?</h3>
  
    <div class="flex">
        {{ Aire::open()->route('categories.destroy', $category) }}
