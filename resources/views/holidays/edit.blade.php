...
<div id="drawer-delete-product-default"
    ...
    <h5 id="drawer-label"
        class="inline-flex items-center text-sm font-bold text-gray-500 uppercase ">Eliminar Festivo
    </h5>
    ...
    <h3 class="mb-6 text-lg text-gray-500 ">¿Está seguro de que desea eliminar este festivo?</h3>
