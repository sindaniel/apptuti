                            ...
                            @foreach ($products as $product)
                                <div class="grid grid-cols-12 items-top gap-x-2">
                                    ...
                                    <div class="xl:col-span-3 col-span-5 px-3 flex flex-col">
                                        ...
                                        <div class=" py-1 flex items-center border border-qgray-border">
                                            <div class="flex justify-between items-center w-full">
                                                ...
                                                <input type="numeric" readonly  name='items[{{$product->id}}]' class="quantity w-10 text-center bg-transparent border-0 text-sm focus:ring-0 focus:outline-none"   value="{{$product->quantity}}">
                                    ...
                                    <div class="items-start justify-center flex"> 
                                        <a href={{route('cart.remove', $product->id)}} class='hover:text-red-500 text-slate-400 mt-1'>
